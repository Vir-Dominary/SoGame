...
import {app,updater,natdetect} from '../models';
...
export function DetectNATType():Promise<natdetect.NATResult>;
...
export function GetNATResult():Promise<natdetect.NATResult>;
